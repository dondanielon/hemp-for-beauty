...
function App() {
  ...
  useEffect(() => {
    ...
    const expirationFromLocal = window.localStorage.getItem(
      "expiration-date-cart-list"
    );
    const listFromLocalStorageJSON =
      window.localStorage.getItem("hempCartList");
        ...
        <Routes>
          <Route path="/" element={<NavBar />}>
            <Route path="/" element={<Footer />}>
              ...
              <Route path="/pagos-y-envios" element={<Payments />} />
              <Route path="/cambios-y-devoluciones" element={<Refund />} />
