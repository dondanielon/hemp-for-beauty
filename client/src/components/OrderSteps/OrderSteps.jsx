  ...
  return (
    <div className={styles.container}>
      <div className={styles.progress}>
        <FactCheckIcon className={step === 1 ? styles.active : styles.inactive}/>
        <span className={styles.dot}/>
        <span className={styles.dot}/>
        <ManageAccountsIcon className={step === 2 ? styles.active : styles.inactive}/>
        <span className={styles.dot}/>
        <span className={styles.dot}/>
      ...
      <div>
        {
          step === 1 ? (
            <ProductListConfirmation setStep={setStep} productsTotal={productsTotal} setProductsTotal={setProductsTotal}/>
          ) : step === 2 ? (
            <MakeOrderAs  setStep={setStep} productsTotal={productsTotal}/>
          ) : step === 3 ? (
            <SelectAdress setStep={setStep}/>
          ) : step === 4 ?(
            <ContinueToPayment />
          ) : (
